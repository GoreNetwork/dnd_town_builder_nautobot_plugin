"""Navigation Items to add to Nautobot for dnd_town_builder_nautobot_plugin."""
...
menu_items = (
    PluginMenuItem(
        link='plugins:dnd_town_builder_nautobot_plugin:model',  # A reverse compatible link to follow.
        ...
        buttons = (  # Optional: Iterable of PluginMenuButton instances to display.
            PluginMenuButton(
                'plugins:dnd_town_builder_nautobot_plugin:model',  # A reverse compatible link to follow.
